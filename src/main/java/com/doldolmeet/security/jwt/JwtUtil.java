package com.doldolmeet.security.jwt;
...
public class JwtUtil {
    ...
    private static final long TOKEN_TIME = 30 * 24 * 60 * 60 * 1000L;
    ...
    // 토큰 생성
    public String createToken(String username, Role role, String nickname, String profileImgUrl) {
        Date date = new Date();
